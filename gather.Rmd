...
```{r fundraisingdata, include = TRUE, echo = FALSE}
...
x16_joined_data <- mit_2016 %>%
  ...
  stringdist_left_join(x16_candidates, by = c("state_po" = "cand_office_st", "district" = "cand_office_district", "candidate_last" = "candidate_last"), ignore_case =TRUE, max_dist = 0) %>%
